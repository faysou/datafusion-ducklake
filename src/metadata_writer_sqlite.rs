...
use crate::metadata_writer::{
    ...
    ExistingCatalogColumn, MetadataWriter, RestoreResult, SnapshotCommitMetadata,
    TableRestoreOptions, WriteMode, WriteSetupResult, assign_column_ids, catalog_column_defs,
    catalog_columns_differ, restored_table_data_changes, table_write_changes, top_level_column_ids,
